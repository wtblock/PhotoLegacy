...
/////////////////////////////////////////////////////////////////////////////
CPhotoPrinterDoc* CMainFrame::GetPhotoPrinterDocument()
{
	CPhotoPrinterDoc* value = nullptr;
	CPhotoPrinterView* pView = nullptr;
	try
	{
		...
		CBaseDoc* pBase = pView->Document;
		value = static_cast<CPhotoPrinterDoc*>(pBase);
	}
	catch (...)
	{
		return value;
...
/////////////////////////////////////////////////////////////////////////////
CPhotoPrinterView* CMainFrame::GetPhotoPrinterView()
{
	CPhotoPrinterView* value = nullptr;
	CMDIChildWnd* pActiveChild = MDIGetActive();
	if (pActiveChild)
		value = static_cast<CPhotoPrinterView*>(pActiveChild->GetActiveView());
	return value;
} // GetPhotoPrinterView
